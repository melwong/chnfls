	...
	private function save_listing() {
		...
		if ( $post_id ) {		
			...
			if ( isset( $_POST['ipfs_cid'] ) ) {
				...
				update_post_meta( $post_id, 'ipfs_cid', $_POST['ipfs_cid'] );

				$ipfs_cid = $_POST['ipfs_cid'];

				$filenames = $_POST['filename'];	//Read the filename array from the form
			...
			if ( isset( $_POST['ipfs_metadata_cid'] ) ) {
				...
				update_post_meta( $post_id, 'ipfs_metadata_cid', $_POST['ipfs_metadata_cid'] );
			}
			//Mel: End
