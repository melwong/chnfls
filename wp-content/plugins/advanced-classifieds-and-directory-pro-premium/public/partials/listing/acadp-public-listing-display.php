	...
	<div class="row">    	
        ...
        <div class="<?php echo $has_sidebar ? 'col-md-8' : 'col-md-12'; ?>">  
            ...
            <!-- <div class="pull-left acadp-post-title">        	 -->
                ...
                // //Mel: 27/01/22
                // $meta[] = sprintf( '<span class="glyphicon glyphicon-zoom-in"></span>&nbsp;<a href="https://testnet.snowtrace.io/tx/%s">%s</a>', $post_meta['tx_hash'][0], esc_html__( 'View on Block Explorer', 'advanced-classifieds-and-directory-pro' ) );
